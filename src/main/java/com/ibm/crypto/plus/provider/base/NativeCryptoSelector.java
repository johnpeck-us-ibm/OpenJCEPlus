...
public class NativeCryptoSelector {
     ...
     */
    public static NativeInterface selectBackend(OpenJCEPlusProvider provider, String type, String algorithm) throws 
        NativeException {
        ...
        if (provider != null && type != null && algorithm != null) {
            ...
            if (service != null) {
                ...
                // Service not found.
                throw new NativeException("Service not found for type " + type + " and algorithm " + algorithm);
            }
        } else {
            throw new NativeException("Provider, Type and Algorithm must not be null");
        }
     ...
     * @return the Backend to use
     */
    private static Backend selectBackendFromAttribute(String nativeProviderValue) throws NativeException {
        ...
        switch (normalized) {
            ...
            default:
                ...
                throw new NativeException("Native backend unknown - " + nativeProviderValue);
        }
